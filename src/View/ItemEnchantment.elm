    ...
    div []
      ...
      , table [] 
        [ tr [] 
          ...
          , td [ class "label" ] [ text (Round.round 2 (allAssistantsCostTotal (totalTimeWeeks model) model.workingConditions)) ]
          ]
        , tr [] 
          [ td [ class "label" ] [ text "Total Cost:" ]
          , td [ class "label" ] [ text (Round.round 2 (allAssistantsCostTotal (totalTimeWeeks model) model.workingConditions + baseEnchantmentCost model)) ]
          ]
        ]
      ]
